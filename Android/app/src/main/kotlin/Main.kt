...
internal val logger: SkipLogger = SkipLogger(subsystem = "ahoy.skipper", category = "AhoySkipper")

private typealias AppRootView = AhoySkipperRootView
private typealias AppDelegate = AhoySkipperAppDelegate
